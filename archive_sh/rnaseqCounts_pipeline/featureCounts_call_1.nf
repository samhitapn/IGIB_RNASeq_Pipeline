...
include { FEATURE_COUNTS as FEATURE_COUNTS_1 } from '/lustre/smriti.a/samhita/src/rnaseqCounts_pipeline/processes/featureCounts_1.nf'
...
workflow {
     ...
     main:
        ...
        FEATURE_COUNTS_1   (sampleID, BAM, params.herv_gtf)
